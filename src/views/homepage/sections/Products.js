    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          <h2 className={classes.title}>Our programs and courses</h2>
      ...
      <div className="mar_t-32">
        <GridContainer spacing={3}>{renderHomepageCourses()}</GridContainer>
      </div>
      <div className="mar_t-32">
        <Button color="primary" round>
          <i className="fas fa-th-list mar_r-16"></i> VIEW ALL COURSES
        </Button>
      </div>
    </div>
  );
